...
import imageEmpty from '@assets/images/bookstore/empty.png';
import imageDarkEmpty from '@assets/images/bookstore/empty-dark.png';
      ...
      >
        ...
        <Grid item>
          <Stack spacing={0.5}>
            ...
            Intente realizar otra búsqueda o utilizar términos más generales.
            </Typography>
            <Box sx={{ pt: 3 }}>
