...
// types
import { CartCheckoutStateProps, CartProductStateProps } from 'src/types/cart';
      ...
      <Grid item xs={12} md={8}>
        <Stack spacing={2}>
                              ...
                              <Grid container alignItems="center" spacing={2}>
                                ...
                                <Grid item>
                                  <Stack spacing={0}>
                                    ...
                                    <Typography color="text.secondary">{row.itemId}</Typography>
                                  </Stack>
                                </Grid>
                              </Grid>
                            </TableCell>
          ...
          <Grid item sx={{ textAlign: 'right' }}>
            <Button color="secondary" component={Link} to="/home" variant="text" startIcon={<LeftOutlined />}>
